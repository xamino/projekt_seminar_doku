...
\begin{figure}
		...
		\caption{Original dataset (top) and sinusoidal approximation (bottom). TODO: MORE TEXT!}
		\label{fig:approx}
\end{figure}
...
\begin{figure}
		...
		\caption{Original dataset (top) and sinusoidal approximation using two overlapping sine functions (bottom). TODO: MORE TEXT!}
		\label{fig:approx2}
\end{figure}
...
\begin{figure}
		...
		\caption{Original dataset of a skipping motion (top) and its sinusoidal approximation (bottom). TODO: MORE TEXT!}
		\label{fig:approx3}
\end{figure}
...
\begin{figure}
	...
	\caption{Normalization effect on coefficients (left side without normalization). TODO: MORE TEXT!}
	\label{fig:sammel}
\end{figure}
...
\begin{lstlisting}[caption=Calculating the angle. TODO: MORE TEXT! Listing should be translated to English!]{Name}
...
# Vector calculations. Enumeration is from point number from Kinect model
...
\begin{figure}
	...
	\caption{Result of rendering. TODO: MORE TEXT!}
	\label{fig:3drender}
\end{figure}
