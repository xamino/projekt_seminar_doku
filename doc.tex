...
A graphical representation of an \emph{eigenposture} can be seen on top of figure \figurename{fig:approx}.
...
The fitted graph of the example mentioned above can be seen at the bottom of figure \figurename{fig:approx}.
