...
While jumping there are unwished side-effects. People can't continuosly jump just up and down, but also back- and sidewards. This fact effects our first two eigenvectors. They loose importance in representing the whole movement. So we idealize the movement by removing all changes to the z-axis. The result can be seen in figure...
\begin{figure}
	\centering
	\includegraphics[width=15cm]{sammel.png}
	\caption{Normalisation effect on coefficents (left side without normalisation.}
	\label{fig:sammel}
\end{figure}
...
% TODO Testpersonen, wohin? Von Tamino: ist doch oben...? Oder wird hier was anderes gemeint?
