...
In \cite{origin} the best result for classification was achieved using the first three eigenpostures. In (f) and (i) anything but the first two eigenpostures were used resulting in a minimum classification of about 22\% each. This is so far the best result.
