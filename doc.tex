...
The blue lines in figures (TODO: Bilder einfügen) show the percentaged number of misclassifications depending on n, the number of used entries of c and $k_{i}$. As you can see, there usually is an n smaller than the number of motions for which is already high enough to classify all motions correctly.

\begin{figure}
		\centering
		\includegraphics[width=\textwidth]{klassifikation.png}
		\caption{TODO: Beschreibung hier einfügen}
...
The motion that was taken out first was then classified using the classifier trained by all of the other motions. This was repeated for all motions, until all motions have been taken out and were classified. The number of misclassifications is shown as the red line in figures (TODO: Bilder einfügen) depending on the number of used principal components.
