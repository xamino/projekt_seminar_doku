...
For this reason we used a take-one-out-strategy, taking one out of our set of recorded motions and computing the classifier c for the remaining motionvectors.
The motion that was taken out first was then classified using the classifier trained by all of the other motionvectors. This was repeated for all motions, until all motions have been taken out and were classified. The number of misclassifications is shown as the red curves in figure \ref{fig:classification} as a function of the number of used principal components.
us
